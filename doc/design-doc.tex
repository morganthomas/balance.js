...
Apply line packing to figure out the best way to split the boxes $b_1,...,b_n$ into lines $l_1,...,l_m$, all of length $w$. On that basis, construct a vbox whose children are a series of hboxes, one hbox per line, where the children of the hboxes are the velements of the boxes $b_1,...,b_n$. Then render that vbox.
