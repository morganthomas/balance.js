...
The input to the line packing algorithm is a sequence of boxes. Fix a sequence of boxes $b_1,...,b_n$ to serve as the input. 

The line packing algorithm is an application of the path optimization algorithm. To specify the line packing algorithm, it suffices to specify the appropriate setup for the path optimization algorithm. We need to start with what paths are.
