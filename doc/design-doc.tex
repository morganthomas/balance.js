...
In my opinion, optimization-based layout promises to offer significant advantages over constraint-based layout, and to be a better approach for most problems. I see the following areas of advantage.
