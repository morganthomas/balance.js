...
Observe that this path optimization algorithm will not necessarily halt. It will halt in the application of line packing, because every path will eventually be advanced into a complete path.
