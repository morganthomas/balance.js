...
balance.js is based on a layout paradigm which is partly new, and partly derived from existing ideas. The most important intellectual ancestor of balance.js is the \TeX\ typesetting engine (which has been used to produce the document you are reading). balance.js is also influenced in other ways by the paradigm of HTML, CSS, and the DOM.
