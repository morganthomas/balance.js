...
\TeX\ is an optimization-based layout engine (the only widely used one I'm aware of). The basic idea of optimization-based layout is not new; Donald Knuth can receive a great deal of credit for conceiving the idea. The conception of optimization-based layout which forms the basis of balance.js is new in very many particulars. I don't propose to dissect what's new and what's old; if you're really curious, you can understand how \TeX\ works by reading the \TeX book, and compare it to balance.js. At a high level, \TeX\ is different from balance.js in part due to numerous limitations in \TeX's design which appear to have been motivated by the need to make \TeX\ run on 1980s computers. balance.js employs a design which is much more abstract and flexible than \TeX's, while being less parsimonious with CPU and memory resources.
