...
valueAt represents the function $f$ which the scalar field is, and gradientAt represents the gradient of $f$. See \texttt{src/differentiable-scalar-field} for more detail.
