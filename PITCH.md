...
My confidence is high that balance.js will deliver on these goals. To make my case concrete, I am able to provide design documents and working code/demos. These artifacts demonstrate a mathematical and philosophical theory of document layout which I am currently translating into production-ready JavaScript.
...
I see the following value propositions for IHS Markit in pursuing my proposal. balance.js would empower IHS Markit to provide more beautiful and innovative information presentation solutions to our clients, bringing more possibilities into the realm of the reasonably inexpensive. If IHS Markit receives credit for the achievement of balance.js, then frontend developers who love balance.js will be attracted to work at IHS Markit. I expect balance.js to be loved, eventually, by a significant proportion of frontend developers around the world.
